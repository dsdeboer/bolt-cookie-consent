!(function(t, e) {
    ...
    function n(t) {
        ...
        return (
            ...
            (n.right = o.body.clientWidth - n.width - n.left),
            (n.bottom = o.body.clientHeight - n.height - n.top),
            n
        );
    }
    function r(t) {
    ...
    function s() {
        ...
        a(e.style, { position: "absolute", top: 0, left: 0, pointerEvents: "none", visibility: "hidden", width: "200px", height: "150px", overflow: "hidden" }),
            e.appendChild(t),
                ...
                !(function() {
                    ...
                    I.forEach(function(t, o) {
                        (t = t[0].toUpperCase() + t.substr(1)),
                            "Top" === t || "Left" === t ? (e[o] += parseFloat(r["border" + t + "Width"])) : (e[o] -= parseFloat(r["border" + t + "Width"]));
                    });
                })(),
            e
        );
        ...
        var t = null,
            ...
            i = function n() {
                return "undefined" != typeof e && e > 16
                    ...
                    : void (("undefined" != typeof t && m() - t < 10) || (null != o && (clearTimeout(o), (o = null)), (t = m()), F(), (e = m() - t)));
            };
    ...
    var Y = { center: "center", left: "right", right: "left" },
        ...
        U = (function(e) {
            function h(e) {
                var o = this;
                t(this, h),
                    _(Object.getPrototypeOf(h.prototype), "constructor", this).call(this),
                        ...
                        value: function() {
                            ...
                            if ("scroll-handle" === this.targetModifier) {
                                ...
                                var a = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - s,
                                    e = { width: 15, height: 0.975 * a * (a / o.scrollHeight), left: t.left + t.width - parseFloat(i.borderLeftWidth) - 15 },
                                    f = 0;
                                a < 408 && this.target === document.body && (f = -11e-5 * Math.pow(a, 2) - 0.00727 * a + 22.58),
                                    this.target !== document.body && (e.height = Math.max(e.height, 24));
                                var l = this.target.scrollTop / (o.scrollHeight - a);
                                return (
                                    (e.top = l * (a - e.height - f) + t.top + parseFloat(i.borderTopWidth)), this.target === document.body && (e.height = Math.max(e.height, 24)), e
                                );
                            }
                        },
                    },
                            ...
                            i.forEach(function(t) {
                                ...
                                S(function() {
                                    "undefined" != typeof o._addAttachClasses &&
                                        (p(o.element, o._addAttachClasses, r),
                                        o.options.addTargetClasses !== !1 && p(o.target, o._addAttachClasses, r),
                        ...
                        value: function() {
                            ...
                            if (this.enabled) {
                                ...
                                var x = {
                                    ...
                                    P = void 0;
                                return (
                                    T.innerHeight > A.documentElement.clientHeight && ((P = this.cache("scrollbar-size", s)), (x.viewport.bottom -= P.height)),
                                    T.innerWidth > A.documentElement.clientWidth && ((P = this.cache("scrollbar-size", s)), (x.viewport.right -= P.width)),
                                    (["", "static"].indexOf(A.body.style.position) !== -1 && ["", "static"].indexOf(A.body.parentElement.style.position) !== -1) ||
                                        ((x.page.bottom = A.body.scrollHeight - b - f), (x.page.right = A.body.scrollWidth - m - a)),
                                    "undefined" != typeof this.options.optimizations &&
                                        ...
                                        !(function() {
                                            ...
                                            if (
                                                ...
                                                (o.right = A.body.scrollWidth - o.left - s.width + a.right),
                                                (o.bottom = A.body.scrollHeight - o.top - s.height + a.bottom),
                                        ...
                                        if (n !== !1) {
                                            ...
                                            t.top ? ((h.top = 0), (r = o.top)) : ((h.bottom = 0), (r = -o.bottom)),
                                                ...
                                                "number" == typeof window.devicePixelRatio &&
                                                    ...
                                                    ((s = Math.round(s * devicePixelRatio) / devicePixelRatio), (r = Math.round(r * devicePixelRatio) / devicePixelRatio)),
                                                (h[B] = "translateX(" + s + "px) translateY(" + r + "px)"),
                                                "msTransform" !== B && (h[B] += " translateZ(0)");
        ...
        position: function(t) {
            ...
            return (
                this.options.constraints.forEach(function(t) {
                    ...
                    var w = b(e, n);
                    ("target" !== d && "both" !== d) ||
                        (o < w[1] && "top" === v.top && ((o += u), (v.top = "bottom")), o + f > w[3] && "bottom" === v.top && ((o -= u), (v.top = "top"))),
                        "together" === d &&
                            ("top" === v.top &&
                                ("bottom" === y.top && o < w[1]
                                    ? ((o += u), (v.top = "bottom"), (o += f), (y.top = "top"))
                                    : "top" === y.top && o + f > w[3] && o - (f - u) >= w[1] && ((o -= f - u), (v.top = "bottom"), (y.top = "bottom"))),
                            "bottom" === v.top &&
                                ("top" === y.top && o + f > w[3]
                                    ? ((o -= u), (v.top = "top"), (o -= f), (y.top = "bottom"))
                                    : "bottom" === y.top && o < w[1] && o + (2 * f - u) <= w[3] && ((o += f - u), (v.top = "top"), (y.top = "top"))),
                            "middle" === v.top &&
                                (o + f > w[3] && "top" === y.top ? ((o -= f), (y.top = "bottom")) : o < w[1] && "bottom" === y.top && ((o += f), (y.top = "top")))),
                        ("target" !== h && "both" !== h) ||
                            (i < w[0] && "left" === v.left && ((i += c), (v.left = "right")), i + l > w[2] && "right" === v.left && ((i -= c), (v.left = "left"))),
                        "together" === h &&
                            (i < w[0] && "left" === v.left
                                ? "right" === y.left
                                    ? ((i += c), (v.left = "right"), (i += l), (y.left = "left"))
                                    : "left" === y.left && ((i += c), (v.left = "right"), (i -= l), (y.left = "right"))
                                : i + l > w[2] && "right" === v.left
                                ? "left" === y.left
                                    ? ((i -= c), (v.left = "left"), (i -= l), (y.left = "right"))
                                    : "right" === y.left && ((i -= c), (v.left = "left"), (i += l), (y.left = "left"))
                                : "center" === v.left &&
                                  (i + l > w[2] && "left" === y.left ? ((i -= l), (y.left = "right")) : i < w[0] && "right" === y.left && ((i += l), (y.left = "left")))),
                        ("element" !== d && "both" !== d) ||
                            (o < w[1] && "bottom" === y.top && ((o += f), (y.top = "top")), o + f > w[3] && "top" === y.top && ((o -= f), (y.top = "bottom"))),
                        ("element" !== h && "both" !== h) ||
                            (i < w[0] && ("right" === y.left ? ((i += l), (y.left = "left")) : "center" === y.left && ((i += l / 2), (y.left = "left"))),
                            i + l > w[2] && ("left" === y.left ? ((i -= l), (y.left = "right")) : "center" === y.left && ((i -= l / 2), (y.left = "right")))),
                        "string" == typeof a
                    ...
                    o < w[1] && (a.indexOf("top") >= 0 ? ((o = w[1]), C.push("top")) : O.push("top")),
                        ...
                        (v.top === r.top && v.left === r.left && y.top === e.attachment.top && y.left === e.attachment.left) ||
    ...
    C.modules.push({
        position: function(t) {
            ...
            return (
                ...
                d.length && c.push(this.getClass("abutted")),
